...
![Выполнение примеров](images/1.png){ #fig:001 width=90% }
...
![Выполнение пункта 2](images/2.png){ #fig:002 width=90% }
...
![Выполнение пункта 3](images/3.png){ #fig:003 width=90% }

4. Просмотрите содержимое файла /etc/password (рис. 4) 

![cat /etc/passwd](./images/4_catEtcPassw.png){ #fig:004 width=90% }
...
![Выполнение пункта 4](images/4.png){ #fig:005 width=90% }

6. Прочитайте man по командам mount, fsck, mkfs, kill (рис 8)

![man по командам](images/5.png){ #fig:006 width=70% }
