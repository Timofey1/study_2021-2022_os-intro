...
![новый каталог](./images/mkdir.png){ #fig:003 width=90% }
...
![Файл меню](./images/menu_file.png){ #fig:005 width=90% }

6. Файл Расширений (рис. 6)

![Файл Расширение](./images/exten_f.png){ #fig:006 width=70% }

7. Работа с файлом (рис. 7)

![Работа с файлом](./images/file_work.png){ #fig:007 width=70% }
